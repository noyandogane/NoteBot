...
async def help(ctx):
    ...
    embed.add_field(name="!add [note]", value="Add a note", inline=False)
    embed.add_field(name="!view", value="View your notes", inline=False)
    embed.add_field(name="!delete [number]", value="Delete a note", inline=False)
